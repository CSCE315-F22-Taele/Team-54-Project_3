 ...
 */
const PaymentConfirmationCashier = () => {
    ...
    return (
        <div>
          ...
          <tbody>
            ...
            <button type="button" className="btn btn-outline-primary" onClick={()=>handleUpdate("Cashier")}>Start a new order</button>
            </div>
        </div>
...
export default PaymentConfirmationCashier;